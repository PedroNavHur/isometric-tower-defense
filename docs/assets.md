...
- Downloaded: July 14, 2026
- Runtime location: `public/models/kenney/hexagon-kit`
...
The previous Tower Defense Kit files remain in `public/models/kenney/tower-defense` as unused prototype history; no active scene path references them.
